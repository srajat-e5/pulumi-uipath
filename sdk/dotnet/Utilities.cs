...
namespace Pulumi.UiPath
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.UiPath.version.txt");
    ...
    internal sealed class UiPathResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public UiPathResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
